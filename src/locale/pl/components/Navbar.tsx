    ...
    <div className="fixed mx-auto border border-[#484b6a] border-t-transparent border-l-transparent border-r-transparent top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-100">
      <div className="flex container lg:py-4 flex-wrap items-center justify-between mx-auto px-4 py-2">
        ...
        <div className="menu hidden md:block md:w-auto">
          <ul className="flex items-center p-4 md:p-0 md:flex-row md:space-x-8 mt-0">
            ...
            <NavLink to="/" onClick={scrollToTopLangChange} className={"block py-2 pl-3 pr-4 text-text-color sm:text-xl rounded md:p-0 hover:cursor-pointer"}>
      ...
      {isOpen && (
        <ul className="flex flex-col py-4 items-center">
          ...
          <NavLink to="/" onClick={scrollToTopLangChangeMobile} className={"block py-2 pl-3 pr-4 text-text-color sm:text-xl rounded md:p-0 hover:cursor-pointer"}>
            <img src="/flags/uk.png" className="w-8 h-5 rounded"/>
          </NavLink>
        </ul>
      )}
